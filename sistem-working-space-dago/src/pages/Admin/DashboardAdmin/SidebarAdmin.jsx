...
const SidebarAdmin = () => {
    // PERUBAHAN: Ubah default selectedMenu menjadi Transaksi (karena Virtual Office di-hide)
    ...
    // useEffect ini sudah tidak diperlukan karena PrivateRoute menangani role check
    // ...

    const menuItems = [
        // ========================================================
        // MENU WORKING SPACE DI-HIDE (TIDAK DITAMPILKAN DI LAYAR)
        // ========================================================
        // { name: "Virtual Office", icon: <MdChair />, path: "/virtualofficeadmin" },
        // { name: "Event Spaces", icon: <RiHomeOfficeLine />, path: "/eventspacesadmin" },
        
        // ========================================================
        // MENU AKTIF UNTUK F&B
        // ========================================================
                ...
                <div className="w-full bg-gray-100 border-b border-gray-300 px-4 lg:px-8 py-3 flex items-center justify-between sticky top-0 z-20">
                    ...
                    <div className="flex items-center space-x-3">
                        <span className="text-sm font-semibold text-gray-800">
                            {userProfile?.detail?.nama || userProfile?.email || "Admin"}
                        </span>
